...
@section('content')
      <header class="bg-white flex flex-row justify-between items-center py-2 px-4 sm:px-6 md:px-8 border-b border-gray-200">
        <div>
            ...
            <h1 class="text-lg sm:text-1xl lg:text-2xl font-bold text-gray-800">Account</h1>
        </div>
                ...
                <form id="filter-form">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        ...
                        <select id="filter-role" name="filter_role"
                            ...
                            <option value="mahasiswa" {{ request('filter_role') == 'mahasiswa' ? 'selected' : '' }}>
                                Mahasiswa</option>
   ...
   <div id="custom-modal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center p-4">
        <div class="bg-white rounded-lg shadow-xl w-full max-w-lg transform transition-all duration-300 ease-out scale-95 opacity-0"
            id="modal-content">
            ...
            <div class="p-6">
                ...
                <div class="w-full max-w-md mx-auto text-sm text-gray-700">
                    <table class="w-full">
                        <tbody>
                            <tr class="border-b">
                                <td class="font-semibold text-gray-500 py-2 pr-2 align-top">Email</td>
                                <td id="modal-email" class="py-2 text-gray-800 font-medium"></td>
                            </tr>
                            <tr class="border-b">
                                <td class="font-semibold text-gray-500 py-2 pr-2 align-top">No. HP</td>
                                <td id="modal-phone" class="py-2 text-gray-800 font-medium"></td>
                            </tr>
                            <tr class="border-b">
                                <td class="font-semibold text-gray-500 py-2 pr-2 align-top">Status</td>
                                <td id="modal-role" class="py-2 text-gray-800 font-medium"></td>
                            </tr>
                            <tr class="border-b">
