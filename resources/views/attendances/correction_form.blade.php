<form action="{{ route('correction.store') }}" method="POST"
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
        <div>
            ...
            <input type="time" name="new_check_in" id="new_check_in"
                   value="{{ old('new_check_in', $oldCheckIn) }}"
                   class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-50
                          focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500
                          text-gray-800 shadow-sm transition duration-150 ease-in-out">
            @error('new_check_in')
    ...
    {{-- Judul Aktivitas --}}
    <div>
        <label for="new_activity_title" class="block text-gray-700 text-sm font-medium mb-2">Judul Aktivitas Baru:</label>
        <input type="text" name="new_activity_title" id="new_activity_title"
               value="{{ old('new_activity_title', $oldActivityTitle) }}"
               placeholder="Contoh: Meeting Proyek X"
               class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-50
                      focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500
                      text-gray-800 shadow-sm transition duration-150 ease-in-out">
    ...
    {{-- Deskripsi Aktivitas --}}
    <div>
        <label for="new_activity_description" class="block text-gray-700 text-sm font-medium mb-2">Deskripsi Aktivitas Baru:</label>
    ...
    <div>
        ...
        <textarea name="reason" id="reason" rows="3"
                  placeholder="Contoh: Lupa check-in, salah input jam, dll."
                  required
                  class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-50
                         focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500
