...
<head>
    ...
    <style>
        ...
        :root {
            ...
            /* Tambahkan ini jika belum ada atau sesuaikan namanya */
        ...
        footer {
            ...
            /* KOREKSI DI SINI: Teks terang di footer */
            padding: 40px 5% 25px;
            text-align: center;
            margin-top: 40px;
    ...
    <main>
        ...
        <section id="about" class="content-section lighter-bg">
            <div class="container">
                ...
                <p>Platform kami menyediakan antarmuka yang mudah digunakan untuk melacak absensi magang Anda secara
                    lancar, memastikan semua tercatat dengan baik dan transparan.</p>
            </div>
        </section>
        ...
        <section id="features" class="content-section card-bg-section">
            <div class="container">
                ...
                <p>Jelajahi fitur inti yang dirancang untuk memaksimalkan dan menyederhanakan pengalaman magang Anda.
                </p>
