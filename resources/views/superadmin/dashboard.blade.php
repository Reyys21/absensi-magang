                        ...
                        <table class="w-full text-sm">
                            <thead class="bg-[##14BDEB] text-[#2A2B2A] uppercase text-xs">
                                <tr>
                                    ...
                                    <th class="p-3 text-left">Bidang</th> {{-- Tambah kolom Bidang --}}
                ...
                <div class="bg-[#F7FFF7] p-6 rounded-2xl shadow-sm border border-gray-100">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <form id="filter-form" method="GET">
                            ...
                            <select name="bidang_filter" id="bidang-filter"
                                class="bg-[#F7FFF7] border-gray-200 rounded-sm text-xs focus:ring-indigo-500 focus:border-indigo-500 ml-2">
